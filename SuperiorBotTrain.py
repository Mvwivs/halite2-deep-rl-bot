...
callbacks = [
    ModelIntervalCheckpoint('dqn_PlanetCaptureBot_weights_{step}.h5f', interval=10000),
    TrainEpisodeLogger()
]

dqn.fit(env, nb_steps=1000000, visualize=False, verbose=0, callbacks=callbacks)
