...
dqn = DQNAgent(model=model, nb_actions=nb_actions, memory=memory, nb_steps_warmup=10_000,
...
dqn.fit(env, nb_steps=50_000, visualize=False, verbose=1, callbacks=callbacks)
